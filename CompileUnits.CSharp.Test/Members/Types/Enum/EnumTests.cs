namespace CompileUnits.CSharp.Test.Members.Types.Enum
{
    internal class EnumTests
    {
        ...
        public void MembersTest()
        {
            ...
            var sut = CompileUnit.FromString(code).Types().OfType<IEnum>().Single();
        ...
        public void MembersValueTest()
        {
            ...
            var sut = CompileUnit.FromString(code).Types().OfType<IEnum>().Single().Members[0];
        ...
        public void MembersAttributesTest()
        {
            ...
            var group = CompileUnit.FromString(code).Types()
                .OfType<IEnum>()
