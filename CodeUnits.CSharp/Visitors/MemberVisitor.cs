    ...
    internal class MemberVisitor : CSharpParserBaseVisitor<MemberDefinition[]>
    {
        ...
        public override MemberDefinition[] VisitClass_member_declaration([NotNull] Class_member_declarationContext context)
        {
            ...
            if (context.destructor_definition() != null)
                return new MemberDefinition[] { Destructor.FromContext(context.destructor_definition(), attributes) };
        ...
        private static MemberDefinition[] GetCommonMembers(Common_member_declarationContext context, CommonDefinitionInfo commonInfo)
        {
            ...
            if (context.constant_declaration() != null)
                return Constants.FromContext(context.constant_declaration(), commonInfo).ToArray();
            ...
            if (context.event_declaration() != null)
                return Events.FromContext(context.event_declaration(), commonInfo).ToArray();
            if (context.conversion_operator_declarator() != null)
                return new ConversionOperatorDefinition[] { ConversionOperator.FromContext(context.conversion_operator_declarator(), commonInfo) };
            if (context.constructor_declaration() != null)
                return new ConstructorDefinition[] { Constructor.FromContext(context.constructor_declaration(), commonInfo) };
            if (context.method_declaration() != null)
                return new MethodDefinition[] { Method.FromContext(context.method_declaration(), new ExtendedDefinitionInfo(commonInfo)) };
            if (context.class_definition() != null)
                return new ClassDefinition[] { Class.FromContext(context.class_definition(), commonInfo) };
            if (context.struct_definition() != null)
                return new StructDefinition[] { Struct.FromContext(context.struct_definition(), commonInfo) };
            if (context.interface_definition() != null)
                return new InterfaceDefinition[] { Interface.FromContext(context.interface_definition(), commonInfo) };
            if (context.enum_definition() != null)
                return new EnumDefinition[] { Enum.FromContext(context.enum_definition(), commonInfo) };
            if (context.delegate_definition() != null)
                return new DelegateDefinition[] { Delegate.FromContext(context.delegate_definition(), commonInfo) };
        ...
        private static MemberDefinition[] GetTypedMembers(Typed_member_declarationContext context, CommonDefinitionInfo commonInfo)
        {
            ...
            if (context.method_declaration() != null)
                return new MethodDefinition[] { Method.FromContext(context.method_declaration(), extendedInfo) };
            if (context.property_declaration() != null)
                return new PropertyDefinition[] { Property.FromContext(context.property_declaration(), extendedInfo) };
            if (context.indexer_declaration() != null)
                return new IndexerDefinition[] { Indexer.FromContext(context.indexer_declaration(), extendedInfo) };
            if (context.operator_declaration() != null)
                return new OperatorDefinition[] { Operator.FromContext(context.operator_declaration(), extendedInfo) };
        ...
        private static IEnumerable<FieldDefinition> FieldDefinitions(Field_declarationContext context, CommonDefinitionInfo commonInfo, TypeUsage type)
        {
            ...
            foreach(var fieldContext in context.variable_declarators().variable_declarator())
                yield return Field.FromContext(fieldContext, fieldDefinitionInfo);
        }
    }
}
